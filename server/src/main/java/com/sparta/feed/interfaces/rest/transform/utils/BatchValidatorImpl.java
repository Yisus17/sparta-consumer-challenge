...
@Slf4j @Component @AllArgsConstructor public class BatchValidatorImpl implements BatchValidator {

    @Override public boolean validateCheckSumForSensors(SensorCollection sensorCollection,
